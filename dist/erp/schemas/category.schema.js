...
exports.Category = Category = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, versionKey: false, collection: 'categories' })
], Category);
exports.CategorySchema = mongoose_1.SchemaFactory.createForClass(Category);
exports.CategorySchema.index({ tenantId: 1, 'name.en': 1 }, { unique: true });
exports.CategorySchema.index({ tenantId: 1, code: 1 }, { unique: true, sparse: true });
